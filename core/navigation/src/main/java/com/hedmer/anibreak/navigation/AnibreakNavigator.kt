...
abstract class AnibreakNavigator {
  val navigationCommands: MutableSharedFlow<NavigationCommand> =
  ...
  val navControllerFlow: MutableStateFlow<NavController?> =
...
abstract class AppComposeNavigator : AnibreakNavigator() {
